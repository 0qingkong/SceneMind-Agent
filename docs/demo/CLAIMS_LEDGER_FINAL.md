...
| AI Glasses Simulator | `frontend/src/views/GlassesView.vue`, `docs/DEVICE_ADAPTERS.md` | Visible simulator disclaimer | “Browser future-device interaction preview”; “当前为浏览器端模拟，不代表已连接真实 AI 眼镜硬件。” | “Connected to real glasses” or vendor SDK telemetry | Device owner |
