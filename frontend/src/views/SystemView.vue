...
const coreState = computed<MemoryCoreState>(() => loading.value ? 'analyzing' : backendUnavailable.value ? 'offline' : readiness.value?.status === 'ready' ? 'idle' : 'warning')
...
<template>
  <section class="system-view">
    ...
    <div class="system-instrument-layout">
      ...
      <div class="system-core-panel"><MemoryCore :state="coreState" compact /></div>
