...
$expectedBuild = "day16-18-product-release"
...
$profileDocs = @("README.md", "docs/DEPLOYMENT.md", "docs/DEMO_RUNBOOK.md", "docs/competition/DEMO_SCRIPT.md")
$profileFailures = @()
...
$simulatorFiles = @("frontend/src/views/GlassesView.vue", "docs/DEVICE_ADAPTERS.md", "docs/competition/CLAIMS_LEDGER.md")
...
$metricFiles = @("README.md", "docs/EVALUATION.md", "docs/COMPETITION_SUMMARY.md", "docs/competition/PITCH_DECK.md", "docs/competition/TECHNICAL_REPORT.md")
...
$trackedForbidden = @(& git -C $repoRoot ls-files "*.pt" "*.db" "*.sqlite" "*.sqlite3" "*.log" "*.mp4" "*.webm")
